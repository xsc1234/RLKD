...
class GRPOTrainer(Trainer):
    ...
    def _generate_and_score_completions(
        ...
        for i, (reward_func, reward_processing_class) in enumerate(
            ...
            with profiling_context(self, reward_func_name):
                if isinstance(
                    ...
                    keys = [key for key in inputs[0] if key not in ["prompt", "completion"]]  ##输入数据！！！
        ...
        # print('rewards_per_func: {}'.format(rewards_per_func))
        # print('self.reward_funcs: {}'.format(self.reward_funcs))
